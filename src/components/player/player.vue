    ...
    >
      <div class="normal-player" v-show="fullScreen">
        ...
        <div class="middle" @touchstart.prevent="middleTouchStart"
          ...
          <Scroll ref="lyricList" class="middle-r" :data="currentLyric.lines">
        ...
        <div class="bottom">
          ...
          <div class="operators">
            ...
            <div class="icon i-left" :class="disableClas">
              <i class="icon-prev" @click="prev"></i>
            </div>
            <div class="icon i-center" :class="disableClas">
              <i :class="playIcon" @click="togglePlaying"></i>
            </div>
            <div class="icon i-right" :class="disableClas">
